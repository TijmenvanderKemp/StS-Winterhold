...
import winterhold.patches.relics.BottledPlaceholderField;
import winterhold.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static winterhold.WinterholdMod.makeRelicOutlinePath;
import static winterhold.WinterholdMod.makeRelicPath;
...
public class BottledPlaceholderRelic extends CustomRelic implements CustomBottleRelic, CustomSavable<Integer> {
    ...
    // ID, images, text.
    public static final String ID = WinterholdMod.makeID("BottledPlaceholderRelic");
