...
public class DefaultSecondMagicNumberSkill extends AbstractWinterholdCard {
    ...
    public static final String ID = WinterholdMod.makeID(DefaultSecondMagicNumberSkill.class.getSimpleName());
