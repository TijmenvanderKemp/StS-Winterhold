...
import winterhold.actions.UncommonPowerAction;
import winterhold.characters.DestructionMage;

import static winterhold.WinterholdMod.makeCardPath;

public class DefaultUncommonPower extends AbstractWinterholdCard {
    ...
    public static final String ID = WinterholdMod.makeID(DefaultUncommonPower.class.getSimpleName());
