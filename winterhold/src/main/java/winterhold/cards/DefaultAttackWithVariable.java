...
public class DefaultAttackWithVariable extends AbstractWinterholdCard {
    ...
    public static final String ID = WinterholdMod.makeID(DefaultAttackWithVariable.class.getSimpleName());
