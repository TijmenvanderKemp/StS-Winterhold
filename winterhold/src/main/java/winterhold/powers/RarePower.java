...
import winterhold.cards.DefaultRareAttack;
...
public class RarePower extends AbstractPower implements CloneablePowerInterface {
    ...
    public static final String POWER_ID = WinterholdMod.makeID("RarePower");
    ...
    private static final Texture tex84 = TextureLoader.getTexture(
        "winterholdResources/images/powers/placeholder_power84.png");
    private static final Texture tex32 = TextureLoader.getTexture(
        "winterholdResources/images/powers/placeholder_power32.png");
