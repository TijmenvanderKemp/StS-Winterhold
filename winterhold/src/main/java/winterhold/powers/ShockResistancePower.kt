...
class ShockResistancePower(owner: AbstractCreature?, amount: Int, isSourceMonster: Boolean) : AbstractPower(),
    ...
    override fun makeCopy(): AbstractPower {
        return ShockResistancePower(owner, amount, isSourceMonster)
    }

    companion object {
        val POWER_ID = makeID(ShockResistancePower::class.java.simpleName)
        private val RESISTANT_TO = SpellDamageType.SHOCK
